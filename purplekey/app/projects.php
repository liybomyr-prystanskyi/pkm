...
<body>
  <main>
    ...
    <section class="project-page">
      <div class="project-page__main" id="projects-m">
        <div class="row pr item">
          <div class="col-12 col-lg-6 padding-none">
            <div class="swiper-container project-page__main__container">
              <div class="swiper-wrapper project-page__main__container__wrapper">
                <div class="swiper-slide project-page__main__container__wrapper__slide">
                  <div class="project-page__main__container__wrapper__slide__image">
                    <img src="img/temp/projects/slide1.png" alt="slide">
                  </div>
                </div>
                <div class="swiper-slide project-page__main__container__wrapper__slide">
                  <div class="project-page__main__container__wrapper__slide__image">
                    <img src="img/temp/projects/slide2.png" alt="slide">
                  </div>
                </div>
              </div>
            </div>
            <div class="yellow-bg-arrow">
              <div class="swiper-button-prev-projects project-page__main__arr-prev">
                <img src="img/temp/home/arrow-next.png" alt="next">
              </div>
              <div class="swiper-button-next-projects project-page__main__arr-next">
                <img src="img/temp/home/arrow-next.png" alt="next">
              </div>
            </div>
          </div>
          <div class="col-12 col-lg-6 padding-none">
            <div class="project-page__main__info">
              <div class="project-page__main__info__title">
        ...
        <div class="project-page__main__more" id="loadMore">
          <a href="javascript:void(0);">More Projects</a>
        </div>
      </div>
    </section>
